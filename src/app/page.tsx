...
export default async function HomePage() {
  ...
  return <div className="page-shell home">
    ...
    <header className="page-intro"><p className="eyebrow">Historical phonology, documented</p><h1>CASC</h1><p className="lede">Corpus of Attested Sound Changes — a searchable, reviewed index of sound changes attested across the world’s languages.</p></header>
